...
<!-- Блок специальностей -->
        <div class="text-center fullscreen-bg">
            ...
            <div class="cards-specialty">
                <div class="row d-flex justify-content-center">
                    <a class="card_link text-light" href="Specialty1.php">
                    ...
                    <a class="card_link text-light" href="Specialty2.php">
                        <div class="card-specialty p-0 col-lg-3 mx-3 my-3 justify-content-center">
                    ...
                    <a class="card_link text-light" href="Specialty3.php">
                        <div class="card-specialty p-0 col-lg-3 mx-3 my-3 justify-content-center">
...
<!-- Партнёры -->
    <div class="text-center fullscreen-bg">
        <div class="text" style="font-size: 38px; color: white;font-weight: bold; padding-top: 5%">Партнёры</div>
    ...
    <footer>
        <div class="container">
            <div class="row" style="color: white">
                <div class="col">
                    <p style="font-weight: 700; font-size: 18p; mt-1 mb-1x;">О КОЛЛЕДЖЕ</p>
                    <ul>
                        <li>О НАС</li>
                ...
                <div class="col">
                    <p style="font-weight: 700; font-size: 18px; mt-1 mb-1;">ОБРАЗОВАНИЕ</p>
                    <ul>
                ...
                <div class="col">
                    <p style="font-weight: 700; font-size: 18px; mt-1 mb-1;">КОНТАКТЫ</p>
                    <ul>
